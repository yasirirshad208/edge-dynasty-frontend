...
const ProductDetail = () => {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        const response = await axios.get(`https://api.edgedynasty.com/api/product/single/${id}`);
  ...
  return (
    <div className="container">
      <div className="product-detail pb-[100px] text-white grid md:grid-cols-2 gap-10 container">
        <div>
          <img
            src={"https://api.edgedynasty.com/" + mainImage}
            alt={product.name}
          ...
          <div className="images-gallery flex flex-wrap gap-2 mt-4">
            {product.sideImages.map((img, index) => (
              <img
                ...
                src={"https://api.edgedynasty.com/" + img}
          ...
          {products.slice(0, 3).map((element) => (
            <div key={element.id} className="">
              <img
                ...
                src={"https://api.edgedynasty.com/" + element.mainImage}
                alt={element.title}
              />
