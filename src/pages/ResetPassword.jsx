...
const ResetPassword = () => {
  ...
  useEffect(() => {
    ...
    //   try {
    //     const response = await axios.get(`http://3.87.157.93:5000/api/user/validate-reset-token/${id}`);
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await axios.post(`http://3.87.157.93:5000/api/user/reset/password/${id}`, { password: newPassword });
