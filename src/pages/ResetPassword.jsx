...
const ResetPassword = () => {
  ...
  useEffect(() => {
    ...
    //   try {
    //     const response = await axios.get(`https://api.edgedynasty.com/api/user/validate-reset-token/${id}`);
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await axios.post(`https://api.edgedynasty.com/api/user/reset/password/${id}`, { password: newPassword });
