...
const ResetPassword = () => {
  ...
  useEffect(() => {
    ...
    //   try {
    //     const response = await axios.get(`http://localhost:5000/api/user/validate-reset-token/${id}`);
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await axios.post(`http://localhost:5000/api/user/reset/password/${id}`, { password: newPassword });
